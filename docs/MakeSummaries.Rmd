...
The main object created is available for download  [here](https://github.com/UofABioinformaticsHub/summaries2GO/data/goSummaries.RDS?raw=true) and this will load as a `tibble` after using the function `read_rds()` (fro the package `readr`)
